...
python3 scripts/dual_learning.py --task $task --dataset $dataset --labeled $labeled --deviceIds $deviceIds --seed $seed \
    ...
    --sample $sample --alpha $alpha --beta $beta --cycle_choice $cycle_choice \
