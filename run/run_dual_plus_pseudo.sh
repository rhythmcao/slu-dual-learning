...
read_lm_path="exp/task_lm/dataset_${1}__surface_False/cell_lstm__emb_400__hidden_400_x_1__decTied__dp_0.5__lr_0.001__l2_1e-05__mn_5.0__bs_16__me_100__bm_5__nb_1"
...
python3 scripts/dual_plus_pseudo.py --task $task --dataset $dataset --labeled $labeled --deviceIds $deviceIds --seed $seed \
    --unlabeled $unlabeled --read_slu_model_path $read_slu_model_path --read_nlg_model_path $read_nlg_model_path --read_lm_path $read_lm_path \
    ...
    --discount $discount --conf_schedule $conf_schedule --sample $sample --alpha $alpha --beta $beta --cycle_choice $cycle_choice \
